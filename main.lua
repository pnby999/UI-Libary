...
local Utility = {}
local Objects = {}
function lucifer:DraggingEnabled(frame, parent)
...
function lucifer.CreateLib(kavName, themeList)
    ...
    elseif themeList == "LuciferX" then
        themeList = themeStyles.LuciferX
    ...
    lucifer:DraggingEnabled(MainHeader, Main)
    ...
    function lucifer:ChangeColor(prope,color)
